...
const { db, Coffee, User, Order } = require("../server/db");
...
const coffees = [
  ...
  },
  {
    productName: "Guayoyo",
    description:
      "Traditional venezuelan coffee prepared by filtering the ground coffee in a cone of cloth and pouring hot water on top of it. It's preferably drank without milk or cream.",
